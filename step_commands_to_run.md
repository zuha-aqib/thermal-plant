...
to test tesseract the OCR we used:

```powershell
 & "C:\Users\zuha.aqib\AppData\Local\Programs\Tesseract-OCR\tesseract.exe" --version
```

```powershell
 py -3.12 -c "import pytesseract; pytesseract.pytesseract.tesseract_cmd = r'C:\Users\zuha.aqib\AppData\Local\Programs\Tesseract-OCR\tesseract.exe'; print(pytesseract.get_tesseract_version())" 
```
