...
```powershell
 py -3.12 .\phase_a_accidental_camera_motion.py ".\synthetic-moved-videos\97. A- 200 Corridor Thermal.mp4" ".\step01-annotate-videos\97. A- 200 Corridor Thermal\regions.json" --show-fixed-polygons
```

```powershell
py -3.12 .\phase_a_accidental_camera_motion.py ".\synthetic-moved-videos\95.fur incin AB Stacks Thermal.mp4" ".\step01-annotate-videos\95.fur incin AB Stacks Thermal\regions.json" --show-fixed-polygons 
```
